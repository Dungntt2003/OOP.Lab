...
public class TestingPassingParameter {
	public static void main(String[] args) {
        DigitalVideoDisc jungleDVD = new DigitalVideoDisc("Jungle","Animation", 19.95f, 100, "hawk");
        DigitalVideoDisc cinderellaDVD = new DigitalVideoDisc("Cinderella", "Roman", 20.95f,200,"Halo");
