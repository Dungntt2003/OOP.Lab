...
public class Aims {
	...
	public static void PlayMedia(Media media) {
		...
		else System.out.println("Media cann't play");
	}
	...
	public static void InputMedia() {
		...
		if (choose4 == 1) {
			...
			myStore.addMedia(new DigitalVideoDisc(title, category,cost, length, director));
		}
		else if (choose4 == 2) {
	...
	public static void CartMenu() {
		...
		case 1 :
			...
			else System.out.println("Invalid number, cann't action");
			break;
		case 2:
			...
			else if (sort == 2) cart.sortByCost();
